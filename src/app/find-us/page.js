  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '0.75rem' }}>
                <a href="https://www.google.com/maps/dir/?api=1&destination=Pavilion+Kuala+Lumpur"
            ...
            <div>
              ...
              <div>
                {hours.map(({ day, time }) => (
                  <div key={day} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', padding: '1rem 0', borderBottom: '1px solid #1A1A1A' }}>
                    ...
                    <span style={{ fontFamily: 'var(--sans)', fontSize: '0.85rem', color: '#888', fontWeight: 300 }}>{time}</span>
                  </div>
                ))}
              </div>
              <div style={{ marginTop: '2.5rem', paddingTop: '2rem', borderTop: '1px solid #1A1A1A' }}>
                ...
                <p style={{ fontFamily: 'var(--sans)', fontSize: '1rem', color: '#fff', fontWeight: 300, lineHeight: 2 }}>
                  +6016-682 4848<br />+6016-224 1804
                </p>
              </div>
            </div>
          </div>
      ...
      <section style={{ width: '100%', height: '480px', position: 'relative' }}>
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.7953064960346!2d101.71305931475403!3d3.1488752977055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc362abd08e8b5%3A0x2e8e0dff80c0ef0e!2sPavilion%20Kuala%20Lumpur!5e0!3m2!1sen!2smy!4v1680000000000!5m2!1sen!2smy"
          width="100%"
          height="100%"
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p style={{ fontFamily: 'var(--sans)', fontSize: '0.95rem', color: '#888', lineHeight: 1.8, fontWeight: 300, maxWidth: '420px', marginBottom: '2.5rem' }}>
