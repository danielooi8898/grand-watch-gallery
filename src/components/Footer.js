        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8" style={{ marginBottom: '4rem' }}>
          ...
          <div className="md:col-span-2">
            <Link href="/" style={{ textDecoration: 'none' }}>
              <div style={{
                fontFamily: 'var(--sans)', fontWeight: 800, letterSpacing: '0.15em',
                textTransform: 'uppercase', color: '#fff', fontSize: '1rem', marginBottom: '1.5rem',
              }}>
                Grand Watch Gallery
              </div>
            </Link>
            <p style={{
              color: '#fff', fontSize: '0.88rem', lineHeight: 1.8, maxWidth: '300px',
              fontWeight: 300, fontFamily: 'var(--sans)', marginBottom: '2rem',
            }}>
            ...
            <div style={{ display: 'flex', gap: '2rem' }}>
              {social.map(s => (
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                  style={{
                    color: '#fff', fontSize: '0.72rem', letterSpacing: '0.18em',
          ...
          {[{ title: 'Navigate', links: col1 }, { title: 'Connect', links: col2 }].map(({ title, links }) => (
            <div key={title}>
              <p style={{
                color: '#B08D57', fontSize: '0.68rem', letterSpacing: '0.28em',
                ...
                {links.map(l => (
                  <li key={l.href} style={{ marginBottom: '0.9rem' }}>
                    <Link href={l.href} style={{
                      ...
                      fontFamily: 'var(--sans)', fontWeight: 300, transition: 'color 0.2s',
                    }}
                      onMouseEnter={e => e.target.style.color = '#B08D57'}
                      onMouseLeave={e => e.target.style.color = '#fff'}
                    >
        ...
        <div style={{ borderTop: '1px solid #222', paddingTop: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
              <p suppressHydrationWarning style={{ color: '#aaa', fontSize: '0.72rem', fontFamily: 'var(--sans)', fontWeight: 300, margin: 0 }}>
                &copy; {YEAR} Grand Watch &amp; Jewellery Sdn. Bhd. (624044-T)
              </p>
              <Link href="/admin/login" style={{
                color: '#444', fontSize: '0.65rem', letterSpacing: '0.12em',
                textTransform: 'uppercase', textDecoration: 'none',
                fontFamily: 'var(--sans)', fontWeight: 400, transition: 'color 0.2s',
              }}
                onMouseEnter={e => e.target.style.color = '#B08D57'}
